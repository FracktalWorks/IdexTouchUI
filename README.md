...
## CHeck with the ```sudo nano /boot/config.txt ``` file for avoidance of the errors with display of **unwanted pixesl , diplay fading etc.,**
...
dtparam=audio=on
dtoverlay=waveshare35a,rotate=270,fps=60,speed=16000000
